...
namespace BLL.Services.Implementations
{
    public class UserService:IUserService
    {
        ...
        {
            // Perform Google login verification using the provided access token
        ...
        public async Task<ResponsePackage<bool>> GoogleRegister(string accessToken, SD.Roles Role)
        {
            ...
            try
            {
                ...
                User newUser = new User { Address=" ", BirthDate=DateTime.UtcNow.AddYears(-18), UserName= "user"+Guid.NewGuid(), Email = tokenInfo.Email,
                FirstName=tokenInfo.GivenName, LastName=tokenInfo.FamilyName,};
